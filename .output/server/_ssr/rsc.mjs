import { i as S3Client, l as NoSuchKey, n as GetObjectCommand, r as DeleteObjectCommand, t as PutObjectCommand } from "../_libs/@aws-sdk/client-s3+[...].mjs";
...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-BoIEDiV_.js\")",
	"clientReferenceDeps": {
		"ea2b1fde91c1": {
			"js": [
		...
		"2267e6aaddbb": {
			...
			"css": ["/assets/calculator-wizard-qEe7OSl6.css"]
		},
		"ff0ff5bd658b": {
			"js": [
...
var server_references_default = { "f2d23089d827": async () => {
	const { bookCompleteBoq, cancelOrder, requestReturn } = await Promise.resolve().then(() => actions_exports);
	return {
		bookCompleteBoq,
		cancelOrder,
		requestReturn
...
function getDraftSecret() {
	return "2ce040f6-e218-4e38-bd19-4a0e0962acea";
}
/**
...
async function revalidatePath(path, type) {
	markActionRevalidation(ACTION_DID_REVALIDATE_STATIC_AND_DYNAMIC$1);
...
var ACTION_DID_REVALIDATE_STATIC_AND_DYNAMIC$1 = 1;
...
function markActionRevalidation(kind) {
	...
	state.actionRevalidationKind = state.actionRevalidationKind === ACTION_DID_REVALIDATE_STATIC_AND_DYNAMIC$1 ? ACTION_DID_REVALIDATE_STATIC_AND_DYNAMIC$1 : kind;
}
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "83c2473f-3c99-4576-aae5-f0636af94ace";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "83c2473f-3c99-4576-aae5-f0636af94ace") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "83c2473f-3c99-4576-aae5-f0636af94ace",
		rootBoundaryId
	});
}
/**
...
var DEFAULT_API_URL$6 = "https://buildanta-monorepo-nest-api.vercel.app";
async function POST$8(request, { params }) {
	const { reference } = await params;
	try {
		const payload = await request.json();
		const apiUrl = (process.env.INVENTORY_API_URL || DEFAULT_API_URL$6).replace(/\/$/, "");
...
var Sora = /* @__PURE__ */ createFontLoader("Sora");
var stages = [
...
var categories = [
	{
		...
		name: "Electrical",
		slug: "electrical",
		blurb: "Wires, switches, lighting and protection"
	},
	{
		icon: "◐",
		name: "Paints",
		slug: "paints",
		blurb: "Interior, exterior and specialist coatings"
	},
	{
		icon: "▦",
		name: "Tiles & Flooring",
		slug: "tiles--flooring",
		blurb: "Tiles, stone, wood and installation materials"
	},
	{
		icon: "♧",
		name: "Sanitaryware & Bathware",
		slug: "sanitaryware--bathware",
		blurb: "Fixtures, faucets, showers and accessories"
	},
	{
		icon: "▧",
		name: "Cement & Structure",
		slug: "cement--structure",
		blurb: "Cement, blocks, aggregates and concrete"
	},
	{
		icon: "Ⅱ",
		name: "Steel & TMT",
		slug: "steel--tmt",
		blurb: "Reinforcement steel and structural sections"
	},
	{
		icon: "◒",
		name: "Waterproofing",
		slug: "waterproofing",
		blurb: "Membranes, compounds and sealants"
	},
	{
		icon: "▤",
		name: "Doors & Windows",
		slug: "doors--windows",
		blurb: "Frames, shutters, glass and hardware"
	},
	{
		icon: "⌂",
		name: "False Ceiling & Drywall",
		slug: "false-ceiling--drywall",
		blurb: "Boards, channels and ceiling systems"
	}
];
var brands = [
	"Havells",
...
var products = [
	{
		...
		price: 390,
		stock: 842,
		description: "Portland pozzolana cement for durable masonry, plastering and general construction.",
		specs: [
			"IS 1489 certified",
			"50 kg moisture-resistant bag",
			"Suitable for RCC and masonry"
		],
		tone: "sand"
	},
	{
		slug: "tata-tiscon-fe550-tmt",
		name: "Tata Tiscon Fe 550SD TMT Bar",
		brand: "Tata Steel",
		category: "Steel & TMT",
		...
		price: 735,
		stock: 216,
		description: "High-strength reinforcement steel engineered for ductility and dependable bonding.",
		specs: [
			"Fe 550SD grade",
	...
	{
		slug: "polycab-frls-wire",
		name: "Polycab FRLS House Wire",
		brand: "Polycab",
		category: "Electrical",
		...
		price: 1890,
		stock: 128,
		description: "Flame-retardant low-smoke copper wire for safer residential electrical installations.",
		specs: [
			"1.5 sq mm copper",
			"FRLS insulation",
			"ISI marked"
	...
	{
		slug: "havells-modular-switch",
		name: "Havells Fabio Modular Switch",
		brand: "Havells",
		category: "Electrical",
		categorySlug: "electrical",
		stage: "Electrical & Wiring",
		...
		price: 168,
		stock: 440,
		description: "Clean-profile modular switch with smooth operation and long electrical life.",
		specs: [
			"10 AX rated",
			"ISI compliant",
			"White finish"
	...
	},
	{
		...
		price: 7180,
		stock: 32,
		description: "Washable luxury interior emulsion with a smooth, rich finish.",
		specs: [
			"High washability",
			"Low odour",
			"Soft sheen finish"
	...
	},
	{
		...
		price: 5690,
		stock: 24,
		description: "Exterior coating formulated to resist rain, algae and harsh sunlight.",
		specs: [
			"Weather protection",
			"Anti-algal formula",
			"Multiple shades"
	...
	{
		slug: "kajaria-marble-tile",
		name: "Kajaria Carrara Marble Tile",
		brand: "Kajaria",
		...
		price: 112,
		stock: 630,
		description: "Glazed vitrified tile with an elegant Carrara marble surface.",
		specs: [
			"Polished finish",
	...
	{
		slug: "somany-anti-skid-tile",
		name: "Somany Anti-Skid Floor Tile",
		brand: "Somany",
		category: "Tiles & Flooring",
		categorySlug: "tiles--flooring",
		stage: "Flooring & Tiling",
		room: ["Bathroom", "Balcony & Terrace"],
		unit: "300 × 300 mm",
		price: 69,
		stock: 780,
		description: "Textured ceramic flooring designed for wet and outdoor spaces.",
		specs: [
			"R10 anti-skid",
			"Matte finish",
			"Easy maintenance"
	...
	{
		slug: "jaquar-faucet",
		name: "Jaquar Florentine Basin Mixer",
		brand: "Jaquar",
		category: "Sanitaryware & Bathware",
		categorySlug: "sanitaryware--bathware",
		stage: "Bathroom & Plumbing",
		room: ["Bathroom"],
		unit: "piece",
		price: 4890,
		stock: 18,
		description: "Chrome-finished basin mixer with smooth ceramic cartridge operation.",
		specs: [
			"Chrome finish",
			"Ceramic cartridge",
			"10-year warranty"
	...
	{
		slug: "cera-wall-hung-wc",
		name: "Cera Wall Hung WC",
		brand: "Cera",
		category: "Sanitaryware & Bathware",
		categorySlug: "sanitaryware--bathware",
		stage: "Bathroom & Plumbing",
		...
		price: 9760,
		stock: 12,
		description: "Space-saving rimless wall-hung closet with a hygienic glazed surface.",
		specs: [
			"Rimless bowl",
			"Soft-close seat",
			"S trap compatible"
	...
	{
		slug: "dr-fixit-roofseal",
		name: "Dr Fixit Roofseal Select",
		brand: "Dr Fixit",
		category: "Waterproofing",
		categorySlug: "waterproofing",
		stage: "Plastering & Waterproofing",
		room: ["Balcony & Terrace"],
		unit: "20 L bucket",
		price: 4650,
		stock: 41,
		description: "Elastomeric terrace waterproofing coating with heat-reflective performance.",
		specs: [
			"Crack bridging",
			"UV resistance",
	...
	},
	{
		...
		name: "Gyproc Standard Gypsum Board",
		brand: "Gyproc",
		category: "False Ceiling & Drywall",
		categorySlug: "false-ceiling--drywall",
		stage: "False Ceiling",
		room: [
			"Living Room",
			"Bedroom",
		...
		price: 540,
		stock: 94,
		description: "Lightweight gypsum board for clean interior partitions and ceilings.",
		specs: [
			"Tapered edge",
	...
	{
		slug: "fenesta-upvc-window",
		name: "Fenesta uPVC Sliding Window",
		brand: "Fenesta",
		category: "Doors & Windows",
		categorySlug: "doors--windows",
		stage: "Doors, Windows, Railings & Glass",
		room: ["Living Room", "Bedroom"],
		unit: "custom size",
		price: 9250,
		stock: 9,
		description: "Weather-sealed two-track sliding window with clear glass and secure hardware.",
		specs: [
...
var DEFAULT_API_URL$5 = "https://buildanta-monorepo-nest-api.vercel.app";
function apiUrl$3(path) {
	return `${(process.env.INVENTORY_API_URL || DEFAULT_API_URL$5).replace(/\/$/, "")}/${path}`;
}
async function fetchCollection(path) {
	const response = await fetch(apiUrl$3(path), {
		cache: "no-store",
...
var getCatalogSnapshot = (0, import_react_react_server.cache)(async () => {
	try {
...
var ACCESS_COOKIE = "buildanta_customer_access";
var REFRESH_COOKIE = "buildanta_customer_refresh";
...
async function supabaseAuthFetch(path, init = {}, accessToken) {
...
async function saveCustomerSession(session, requestUrl) {
...
function textMetadata(metadata, key) {
	const value = metadata?.[key];
	return typeof value === "string" && value.trim() ? value.trim() : null;
}
var Header = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'Header' is called on server");
}, "06617d537330", "Header");
...
var layout_exports$9 = /* @__PURE__ */ __exportAll({
...
var sora = Sora({
	variable: "--font-sora",
	subsets: ["latin"],
	_selfHostedCSS: "/* latin-ext */\n@font-face {\n  font-family: 'Sora';\n  font-style: normal;\n  font-weight: 100 800;\n  font-display: swap;\n  src: url(C:/Users/adity/OneDrive/Desktop/buildanta pvt limited/.vinext/fonts/sora-720974a1e66c/sora-1c52a9f3.woff2) format('woff2');\n  unicode-range: U+0100-02BA, U+02BD-02C5, U+02C7-02CC, U+02CE-02D7, U+02DD-02FF, U+0304, U+0308, U+0329, U+1D00-1DBF, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20C0, U+2113, U+2C60-2C7F, U+A720-A7FF;\n}\n/* latin */\n@font-face {\n  font-family: 'Sora';\n  font-style: normal;\n  font-weight: 100 800;\n  font-display: swap;\n  src: url(C:/Users/adity/OneDrive/Desktop/buildanta pvt limited/.vinext/fonts/sora-720974a1e66c/sora-0036cf31.woff2) format('woff2');\n  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;\n}\n"
});
var metadata$10 = {
	title: {
		default: "Buildanta — Every Build Detail in One Place",
	...
	openGraph: {
		...
		images: [{
			url: "/og.png",
			alt: "Buildanta construction-material marketplace"
		}]
	}
};
async function RootLayout({ children }) {
	...
	const chrome = {
		categories: rootNodes(catalog.categories).map(({ name, slug }) => ({
			name,
			slug
		})),
		rooms: rootNodes(catalog.rooms).map((room) => room.name),
		stages: activeStages.map((stage) => stage.name),
		inventoryHref: "http://localhost:3002/dashboard",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("html", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("body", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Header, { ...chrome }),
				catalog.source === "fallback" && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "catalog-status-notice",
					role: "status",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Live catalogue temporarily unavailable." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Showing a limited browsing catalogue. Current pricing and availability require confirmation." })]
				}),
				children,
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Footer, { ...chrome })
			]
		})
	});
}
...
var DEFAULT_API_URL$4 = "https://buildanta-monorepo-nest-api.vercel.app";
async function calculateWithRetry(url, payload) {
	let lastError;
...
async function POST$7(request, { params }) {
	const { slug } = await params;
	try {
		const payload = await request.json();
		const response = await calculateWithRetry(`${(process.env.INVENTORY_API_URL || DEFAULT_API_URL$4).replace(/\/$/, "")}/calculators/public/${encodeURIComponent(slug)}/calculate`, payload);
...
var DEFAULT_API_URL$3 = "https://buildanta-monorepo-nest-api.vercel.app";
var professionalCategories = [
	{
		...
		singular: "Contractor",
		short: "C",
		description: "Execution experts for civil work, renovation and complete project delivery."
	},
	{
		...
		short: "ID",
		description: "Design specialists for functional, beautiful residential and commercial spaces."
	},
	{
		slug: "builders",
		type: "BUILDER",
		...
		singular: "Builder",
		short: "B",
		description: "Experienced teams for residential, commercial and redevelopment projects."
	},
	{
		slug: "architects",
		type: "ARCHITECT",
		...
		singular: "Architect",
		short: "A",
		description: "Planning and design professionals who bring buildable ideas to life."
	},
	{
		slug: "product-owners",
		type: "PRODUCT_OWNER",
		...
		short: "PO",
		description: "Material and product specialists with category expertise and supply knowledge."
	}
];
function apiUrl$2(path) {
	return `${(process.env.INVENTORY_API_URL || DEFAULT_API_URL$3).replace(/\/$/, "")}/${path}`;
}
function isProfessional(value) {
	if (!value || typeof value !== "object") return false;
	const record = value;
	return typeof record.id === "string" && typeof record.name === "string" && typeof record.slug === "string" && typeof record.location === "string" && professionalCategories.some((category) => category.type === record.type);
}
async function getProfessionals(type) {
	try {
		const query = type ? `?type=${encodeURIComponent(type)}` : "";
		const response = await fetch(apiUrl$2(`professionals${query}`), {
			cache: "no-store",
			headers: { accept: "application/json" }
		});
...
async function getProfessional(slug) {
	try {
		const response = await fetch(apiUrl$2(`professionals/${encodeURIComponent(slug)}`), {
			cache: "no-store",
			headers: { accept: "application/json" }
		});
		if (!response.ok) return null;
...
var DEFAULT_API_URL$2 = "https://buildanta-monorepo-nest-api.vercel.app";
var defaultHomepageSlide = {
	...
	imageUrl: "/homepage_img.png",
	altText: "Home renovation journey from unfinished to fully designed",
...
var getHomepageContent = (0, import_react_react_server.cache)(async () => {
	try {
		const baseUrl = (process.env.INVENTORY_API_URL || DEFAULT_API_URL$2).replace(/\/$/, "");
		const response = await fetch(`${baseUrl}/homepage-content`, {
			cache: "no-store",
			headers: { accept: "application/json" }
		});
...
var HeroSlider = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'HeroSlider' is called on server");
}, "893c93e3d3a0", "HeroSlider");
function HomepageProductCard({ product, badge }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
		className: "product-card homepage-product-card",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
					...
					children: badge || product.brand
				}),
				product.image ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
					src: product.image,
					alt: product.imageAlt,
					loading: "lazy"
				}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: product.category.split(" ")[0] }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", { children: availabilityLabel(product) })
			]
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
					href: `/products/${product.slug}`,
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: product.name })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "product-description",
					children: product.description
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: product.price > 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: ["From ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", { children: ["₹", product.price.toLocaleString("en-IN")] })] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Project pricing" }) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
...
var BrandMark = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'BrandMark' is called on server");
}, "a1cb92d99abb", "BrandMark");
var page_exports$19 = /* @__PURE__ */ __exportAll({ default: () => Home });
var roomImages = {
...
function SectionTitle({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {})
		]
	});
}
async function Home() {
	const [catalog, professionals, homepageContent] = await Promise.all([
		getCatalogSnapshot(),
		getProfessionals(),
		getHomepageContent()
	]);
	...
	const featuredProducts = selectedProducts.length ? selectedProducts : catalog.products.slice(0, 8).map((product) => ({
		product,
		badge: null
	}));
	const categoryShowcase = categories.map((category) => {
		return {
			category,
			products: catalog.products.filter((product) => product.categories.includes(category.name))
		};
	}).sort((a, b) => b.products.length - a.products.length || a.category.name.localeCompare(b.category.name)).slice(0, 8);
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(HeroSlider, { slides }),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "commerce-assurance",
			"aria-label": "Buildanta shopping benefits",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Verified catalogue" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Managed from Buildanta Inventory" })] }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Project pricing" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Request quotes for any quantity" })] }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Construction focused" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Browse by stage, room or category" })] })
			]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "home-section brands-section",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Trusted Brands" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "section-subtitle",
					children: "Quality products from the brands managed in your inventory"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						...
						children: repeatedBrands.map((brand, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							className: "brand-card",
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(BrandMark, {
								name: brand.name,
								logo: brand.logo
							})
						}, `${brand.id}-${index}`))
		...
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "home-section featured-products-section",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Inventory selected" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Featured Building Materials" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Products, images and prices stay connected to the inventory catalogue." })
				] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
					className: "view-all",
					href: "/categories",
					children: ["View all products ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })]
				})]
			}), featuredProducts.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "homepage-products-grid",
				children: featuredProducts.map(({ product, badge }) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(HomepageProductCard, {
					product,
					badge
				}, product.id))
			}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "homepage-products-empty",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "Featured products are being prepared." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Add products in Inventory, then select them under Homepage." })]
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "home-section project-planner-section",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "project-planner-card",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "project-planner-copy",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "COMPLETE CONSTRUCTION MATERIAL PLANNER" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Start with your area. Leave with a connected material plan." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Enter your project name, location, plot and built-up area, floors, rooms and construction scope. Buildanta prepares a preliminary stage-wise schedule using managed calculation profiles and products published from Inventory." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "project-planner-actions",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								className: "button orange",
								href: "/calculators/complete-construction-material",
								children: "Get full construction material info"
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								href: "/calculators",
								children: "View all calculators ->"
							})]
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "project-planner-features",
					"aria-label": "Construction planner features",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "01" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Choose the scope" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Foundation only, structural shell or full-finish planning." })] })] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "02" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Review stage-wise quantities" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "See raw requirements, wastage and rounded purchase quantities." })] })] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "03" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Use connected products" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Products, variants, indicative prices and PIN-code status come from Inventory." })] })] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "04" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Request one quotation" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Send every selected material to the existing multi-item quote workflow." })] })] })
					]
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
				className: "project-planner-disclaimer",
				children: "Preliminary planning only. Final quantities require architectural, structural and MEP drawings reviewed by qualified professionals."
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "home-section",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionTitle, { children: "Shop by Construction Stage" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "stage-panel",
				children: stages.map((stage, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
					href: `/by-stage?stage=${encodeURIComponent(stage.name)}`,
					className: "stage-item",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							className: "stage-icon",
							children: materialIcons[index % materialIcons.length]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: stage.name }),
						index < stages.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", { children: "›" })
					]
				}, stage.id))
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "home-section",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionTitle, { children: "Shop by Room" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "room-grid",
				children: rooms.map((room) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
					href: `/by-room?room=${encodeURIComponent(room.name)}`,
					className: "room-card",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
						src: roomImages[room.name] || "/livingroom.jpg",
						alt: room.name
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: room.name })]
				}, room.id))
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "home-section category-showcase-section",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "section-heading-row",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Shop the catalogue" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Materials organized by category" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "See real inventory products inside every category, not an empty directory." })
				] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
					className: "view-all",
					href: "/categories",
					children: ["View all categories ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })]
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "category-showcase-grid",
				children: categoryShowcase.map(({ category, products }, index) => {
					const preview = products[0];
					return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						href: `/categories/${category.slug}`,
						className: `category-showcase-card ${preview?.image ? "has-image" : ""}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "category-showcase-visual",
							children: [preview?.image ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
								src: preview.image,
								alt: "",
								loading: "lazy"
							}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: materialIcons[index % materialIcons.length] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("b", { children: [
								products.length,
								" ",
								products.length === 1 ? "product" : "products"
							] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Construction category" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: category.name }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: products.length ? products.slice(0, 2).map((product) => product.name).join(" · ") : "Products can be added from Buildanta Inventory." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", { children: ["Explore category ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })] })
						] })]
					}, category.id);
				})
			})]
		...
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionTitle, { children: "For Professionals" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "professional-banner",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
							src: "/forprofessionalsbanner.png",
							alt: "Construction professionals collaborating on a project"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "professional-banner-actions",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "professional-banner-types",
							children: professionalCategories.map((category) => {
								const count = professionals.filter((item) => item.type === category.type).length;
								return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
									href: `/professionals/${category.slug}`,
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: category.short }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: category.title }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("small", { children: [count, " profiles"] })
									]
								}, category.type);
							})
						})
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
					className: "view-all",
					href: "/professionals",
					children: ["Explore all professionals ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })]
				})
			]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "home-section why-section",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionTitle, { children: "Why Us" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
				className: "why-image",
				src: "/whyus.png",
				alt: "Buildanta service benefits"
			})]
		})
	] });
}
var CustomerLogoutButton = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'CustomerLogoutButton' is called on server");
}, "5d017b3bfd6a", "CustomerLogoutButton");
var API = (process.env.INVENTORY_API_URL || process.env.NEXT_PUBLIC_API_URL || "http://localhost:5173").replace(/\/$/, "");
async function getCustomerPortal() {
	const token = await getCustomerAccessToken();
	if (!token) return {
		data: null,
		error: "Your customer session has expired."
	};
	try {
		...
		if (!response.ok) return {
			data: null,
			error: "Your quotation and order history could not be loaded."
		};
		return {
		...
		return {
			data: null,
			error: "The customer workspace is temporarily unavailable."
		};
	}
}
async function customerPortalMutation(path, body) {
	const token = await getCustomerAccessToken();
	if (!token) throw new Error("Your customer session has expired.");
	...
	if (!response.ok) {
		...
		throw new Error(Array.isArray(payload.message) ? payload.message.join(" ") : payload.message || "The request could not be completed.");
	}
}
var actions_exports = /* @__PURE__ */ __exportAll({
	bookCompleteBoq: () => bookCompleteBoq,
...
async function bookCompleteBoq(form) {
	let target = "/account?notice=Complete%20BOQ%20booked.%20Your%20sales%20order%20and%20stock%20reservation%20are%20ready.";
	try {
		await customerPortalMutation(`quotations/${String(form.get("quotationId"))}/book`);
	} catch (error) {
		target = `/account?error=${encodeURIComponent(message(error))}`;
	}
	revalidatePath("/account");
	redirect(target);
}
async function cancelOrder(form) {
	let target = "/account?notice=Order%20cancelled%20and%20stock%20released.";
	try {
		await customerPortalMutation(`sales-orders/${String(form.get("orderId"))}/cancel`, { reason: String(form.get("reason") || "") });
	} catch (error) {
		target = `/account?error=${encodeURIComponent(message(error))}`;
	}
	revalidatePath("/account");
...
async function requestReturn(form) {
	let target = "/account?notice=Return%20request%20submitted.";
	try {
		const items = [...form.entries()].filter(([key]) => key.startsWith("quantity:")).map(([key, value]) => ({
			salesOrderItemId: key.slice(9),
			quantity: Number(value)
		})).filter((item) => Number.isInteger(item.quantity) && item.quantity > 0);
		await customerPortalMutation(`sales-orders/${String(form.get("orderId"))}/returns`, {
...
bookCompleteBoq = /* @__PURE__ */ registerServerReference(bookCompleteBoq, "f2d23089d827", "bookCompleteBoq");
cancelOrder = /* @__PURE__ */ registerServerReference(cancelOrder, "f2d23089d827", "cancelOrder");
requestReturn = /* @__PURE__ */ registerServerReference(requestReturn, "f2d23089d827", "requestReturn");
var SubmitButton = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'SubmitButton' is called on server");
}, "ea2b1fde91c1", "SubmitButton");
var page_exports$18 = /* @__PURE__ */ __exportAll({ default: () => CustomerAccountPage });
var money = (value) => `INR ${Number(value).toLocaleString("en-IN", { maximumFractionDigits: 2 })}`;
var date = (value) => value ? new Date(value).toLocaleDateString("en-IN", {
	day: "numeric",
	month: "short",
	year: "numeric"
}) : "Pending";
async function CustomerAccountPage({ searchParams }) {
	const [customer, catalog, portal, result] = await Promise.all([
		getCustomerUser(),
		getCatalogSnapshot(),
		getCustomerPortal(),
		searchParams
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "account-hero-copy",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "CUSTOMER WORKSPACE" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: [
							"Welcome back, ",
							customer.firstName ?? customer.displayName,
							"."
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Track quotations, accepted orders and delivery from the same live catalogue used by Buildanta Inventory." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "account-hero-actions",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
								className: "button orange",
								href: "/categories",
								children: ["Browse materials ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "->" })]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								className: "button account-outline",
								href: "/bulk-quotes",
								children: "Start a quotation"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("small", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {}), " Live operations connected through the Inventory API"] })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "account-hero-visual",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
						src: recommendations[0]?.image ?? "/demo/hero/project-planning.png",
						alt: "Construction materials selected for a building project"
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Signed in as" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: customer.email })] })]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "account-quick-actions",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						href: "#customer-operations",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "01" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Track requests" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Review quotations, orders and delivery events." })] }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Request project pricing" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Send multiple materials in one quotation." })] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "->" })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Find professionals" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Discover contractors, designers and architects." })] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "->" })
						]
					})
				]
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "customer-operations",
				id: "customer-operations",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "section-heading-row",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Connected operations" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Your quotations and orders" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Pricing, GST, freight and delivery appear only after staff approval." })
						] })
					}),
					result.notice && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "customer-operation-message success",
						role: "status",
						children: result.notice
					}),
					result.error && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "customer-operation-message error",
						role: "alert",
						children: result.error
					}),
					portal.error && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "customer-operation-message error",
						role: "alert",
						children: portal.error
					}),
					portal.data?.quotations.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "customer-operation-list",
						children: portal.data.quotations.map((quote) => {
							const revision = quote.revisions[0];
							const order = quote.salesOrder;
							const canBook = quote.status === "QUOTED" && Boolean(revision) && new Date(revision.validUntil) > /* @__PURE__ */ new Date();
							const finalQuotePending = ["SUBMITTED", "REVIEWING"].includes(quote.status);
							const finalQuoteExpired = quote.status === "QUOTED" && Boolean(revision) && new Date(revision.validUntil) <= /* @__PURE__ */ new Date();
							const canCancel = order?.status === "CONFIRMED";
							const canReturn = order?.status === "DELIVERED" && !order.returnRequests.some((item) => ![
								"REJECTED",
								"RESOLVED",
								"CANCELLED"
							].includes(item.status));
							return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
								className: "customer-operation-card",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("small", { children: ["QUOTATION ", quote.reference] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: quote.items.map((item) => item.description).join(", ") })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: quote.status.replaceAll("_", " ") })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
										className: "customer-line-items",
										children: (revision?.items ?? quote.items).map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: item.description }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("small", { children: [
											Number(item.quantity),
											" ",
											item.unitCode
										] })] }, index))
									}),
									revision && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dl", {
										className: "customer-quote-summary",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Revision" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: revision.number })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Valid until" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: date(revision.validUntil) })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "GST" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: money(revision.gstTotal) })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Freight" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: money(revision.freightTotal) })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Grand total" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: money(revision.grandTotal) })] })
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Timeline, { events: quote.history.map((item) => ({
										label: item.toStatus,
										date: item.createdAt
									})) }),
									finalQuotePending && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "customer-booking-status",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Final quotation is being prepared" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Buildanta Inventory is confirming products, stock, GST, freight and delivery. The booking option will appear here after approval." })] })]
									}),
									finalQuoteExpired && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "customer-booking-status expired",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "This final quotation has expired" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Request an updated price and availability confirmation before booking the complete BOQ." })] })]
									}),
									canBook && revision && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
										className: "customer-booking-panel",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "FINAL QUOTATION READY" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h4", { children: "Book the complete BOQ" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
												"This books all ",
												revision.items.length,
												" approved material lines for ",
												money(revision.grandTotal),
												" and creates one connected Inventory sales order with stock reservations."
											] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ul", { children: [
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Complete approved material schedule" }),
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Price and GST snapshot" }),
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Inventory stock reservation" }),
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "Order and delivery tracking" })
											] })
										] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("form", {
											action: bookCompleteBoq,
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(SubmitButton, {
													className: "button orange",
													pendingText: "Booking complete BOQ...",
													children: ["Book complete BOQ ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "->" })]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Booking confirms the final quotation and reserves available stock." })
											]
										})]
									}),
									order && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
										className: "customer-order",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "BOQ BOOKED / SALES ORDER" }),
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h4", { children: order.reference }),
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: order.status.replaceAll("_", " ") })
											] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
												"Payment: ",
												...
												order.reservedUntil ? ` / Stock reserved until ${date(order.reservedUntil)}` : ""
											] }),
											order.dispatches.map((dispatch) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
												className: "customer-dispatch",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", { children: ["Dispatch ", dispatch.reference] }),
													/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [dispatch.status.replaceAll("_", " "), dispatch.trackingReference ? ` / Tracking ${dispatch.trackingReference}` : ""] }),
													/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Timeline, { events: dispatch.history.map((item) => ({
														label: item.toStatus,
														date: item.createdAt
													})) })
												]
											}, dispatch.reference)),
											order.returnRequests.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
												className: "customer-return",
												children: [
													"Return ",
													item.reference,
													": ",
													/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: item.status })
												]
											}, item.reference)),
											canCancel && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("details", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("summary", { children: "Cancel this order" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("form", {
												action: cancelOrder,
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("input", {
														type: "hidden",
													...
													/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("label", { children: ["Reason", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("textarea", {
														name: "reason",
														minLength: 3,
														required: true
													})] }),
													/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SubmitButton, {
														className: "button account-outline",
											...
											canReturn && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("details", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("summary", { children: "Request a return" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("form", {
												...
												children: [
													...
													order.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("label", { children: [item.description, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("input", {
														type: "number",
					...
					}) : !portal.error && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "customer-operation-empty",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "No quotations yet" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Create one multi-item request and it will appear here automatically." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								className: "button navy",
								href: "/bulk-quotes",
								children: "Start a quotation"
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "section-heading-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "From the live catalogue" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Materials to continue exploring" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Recommendations update when Inventory publishes products and images." })
					] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						className: "view-all",
						href: "/categories",
						children: ["View catalogue ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "->" })]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "account-product-grid",
					children: recommendations.map((product) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						href: `/products/${product.slug}`,
						className: "account-product",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
								src: product.image || fallbackProductImage(product.category),
								alt: product.image ? product.imageAlt : `${product.category} material`
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: availabilityLabel(product) })] }),
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: product.price > 0 ? `Indicative INR ${product.price.toLocaleString("en-IN")} / ${product.unit}` : "Request latest project price" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("b", { children: ["View product ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "->" })] })
						]
					}, product.id))
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "ACCOUNT DETAILS" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Your Buildanta account" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Quotation ownership is matched securely to this email." })
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "customer-account-card",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Email address" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: customer.email })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(CustomerLogoutButton, {})
				]
			})
		]
	});
...
function Timeline({ events }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ol", {
		className: "customer-timeline",
		children: events.map((event, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: event.label.replaceAll("_", " ") }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: date(event.date) })] })] }, `${event.label}-${event.date}-${index}`))
	});
}
...
var route_exports$10 = /* @__PURE__ */ __exportAll({ GET: () => GET$3 });
var apiUrl$1 = (process.env.INVENTORY_API_URL || "https://buildanta-monorepo-nest-api.vercel.app").replace(/\/$/, "");
async function GET$3() {
	try {
		const response = await fetch(`${apiUrl$1}/calculators/public`, {
			headers: { accept: "application/json" },
			cache: "no-store"
		});
		const body = await response.json().catch(() => ({ message: "Calculator service returned an invalid response." }));
...
var route_exports$9 = /* @__PURE__ */ __exportAll({ POST: () => POST$6 });
async function POST$6(request) {
	...
	if (!response.ok) return Response.json({ error: await authErrorMessage(response) }, { status: response.status });
...
async function POST$4(request) {
	...
	if (!accessToken || !refreshToken) return Response.json({ error: "The confirmation session is incomplete." }, { status: 400 });
	const verification = await supabaseAuthFetch("/auth/v1/user", { method: "GET" }, accessToken);
	if (!verification.ok) return Response.json({ error: await authErrorMessage(verification) }, { status: 401 });
...
async function POST$3(request) {
	...
	const email = typeof body?.email === "string" ? body.email.trim().toLowerCase() : "";
	const password = typeof body?.password === "string" ? body.password : "";
	if (!firstName || !lastName || !email || password.length < 8) return Response.json({ error: "Name, email and a password of at least 8 characters are required." }, { status: 400 });
	...
	if (Array.isArray(result.user?.identities) && result.user.identities.length === 0) return Response.json({ error: "An account already exists for this email. Please sign in." }, { status: 409 });
...
var DEFAULT_API_URL$1 = "https://buildanta-monorepo-nest-api.vercel.app";
async function POST$1(request) {
	try {
		const payload = await request.json();
		const response = await fetch(`${(process.env.INVENTORY_API_URL || DEFAULT_API_URL$1).replace(/\/$/, "")}/quote-requests`, {
			method: "POST",
			headers: {
				"content-type": "application/json",
				accept: "application/json"
...
var inventoryApiUrl = (process.env.INVENTORY_API_URL || process.env.NEXT_PUBLIC_API_URL || "http://localhost:5173").replace(/\/$/, "");
...
function r2Client() {
	...
	if (!accountId || !accessKeyId || !secretAccessKey) throw new Error("R2_ACCOUNT_ID, R2_ACCESS_KEY_ID and R2_SECRET_ACCESS_KEY must be set.");
	client = new S3Client({
		region: "auto",
...
async function POST(request) {
	try {
		...
		if (!(image instanceof File) || ![
			...
			"image/jpeg",
			"image/webp"
		].includes(image.type) || image.size > 5e6) return Response.json({ error: "Upload a PNG, JPG or WebP image smaller than 5 MB." }, { status: 400 });
		const reference = `LP-${(/* @__PURE__ */ new Date()).toISOString().slice(2, 10).replaceAll("-", "")}-${crypto.randomUUID().slice(0, 6).toUpperCase()}`;
		...
		const apiUrl = (process.env.INVENTORY_API_URL || "https://buildanta-monorepo-nest-api.vercel.app").replace(/\/$/, "");
...
var page_exports$17 = /* @__PURE__ */ __exportAll({ default: () => page_default });
var page_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "6178223e1909", "default");
var QuoteForm = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'QuoteForm' is called on server");
}, "385723b0c19e", "QuoteForm");
var page_exports$16 = /* @__PURE__ */ __exportAll({ default: () => BulkQuotes });
async function BulkQuotes({ searchParams }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "FOR BUILDERS, CONTRACTORS & PROFESSIONALS" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Get Bulk Quotes" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Build one material basket, confirm delivery details and send the complete requirement to the connected Buildanta sales workspace." }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ol", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "1" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Build your basket" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Select exact products, variants and quantities." })] })] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "2" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Review one request" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Confirm the material summary and delivery PIN code." })] })] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "3" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Receive a controlled quote" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Sales verifies allocation, GST, freight and validity." })] })] })
				] })
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "form-card",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					...
					children: "MULTI-ITEM QUOTATION"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Request project pricing" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Products are loaded from the live Inventory catalogue." }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(QuoteForm, {
...
var layout_exports$8 = /* @__PURE__ */ __exportAll({
	default: () => Layout$8,
	metadata: () => metadata$9
});
var metadata$9 = {
	title: "Request Bulk Construction Quotes",
	description: "Send your construction-material requirement and request project pricing from the Buildanta team."
};
function Layout$8({ children }) {
	return children;
}
var ProductBrowser = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ProductBrowser' is called on server");
}, "fbbd38950b66", "ProductBrowser");
var ProductCard = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ProductCard' is called on server");
}, "fbbd38950b66", "ProductCard");
var page_exports$15 = /* @__PURE__ */ __exportAll({ default: () => ByRoom });
async function ByRoom({ searchParams }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "BUILDANTA PRODUCT DISCOVERY" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Shop by Room" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Explore materials and finishes selected for every space in your home." })
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProductBrowser, {
			mode: "room",
			products: catalog.products,
			options,
			initial: params.room,
...
var layout_exports$7 = /* @__PURE__ */ __exportAll({
	default: () => Layout$7,
	metadata: () => metadata$8
});
var metadata$8 = {
	title: "Shop Materials by Room",
	description: "Browse construction and interior materials for kitchens, bathrooms, bedrooms, living rooms and outdoor spaces."
};
function Layout$7({ children }) {
	return children;
}
var page_exports$14 = /* @__PURE__ */ __exportAll({ default: () => ByStage });
async function ByStage({ searchParams }) {
	const [params, catalog] = await Promise.all([searchParams, getCatalogSnapshot()]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "listing-page stage-listing-page",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "page-intro stage-page-intro",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "PLAN THE BUILD, PHASE BY PHASE" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Shop by Construction Stage" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Choose the phase you are working on and see only the materials mapped to it in Buildanta Inventory." }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "stage-intro-points",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Live inventory mapping" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Indicative project pricing" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Quote-ready products" })
					]
				})
			] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
				src: "/demo/products/real/steel.jpg",
				alt: "Construction worker inspecting reinforcement steel"
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "CATALOGUE COVERAGE" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", { children: [options.length, " active stages"] })] })] })]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProductBrowser, {
			mode: "stage",
			products: catalog.products,
			options,
			initial: params.stage,
			query: params.q
		})]
	});
}
var layout_exports$6 = /* @__PURE__ */ __exportAll({
	default: () => Layout$6,
	metadata: () => metadata$7
});
var metadata$7 = {
	title: "Shop Materials by Construction Stage",
	description: "Find Buildanta construction materials for foundation, masonry, waterproofing, flooring, electrical and finishing stages."
};
function Layout$6({ children }) {
	return children;
}
...
})(import_react_react_server.default, __vite_rsc_assets_manifest_default.serverResources["app/calculators/page.tsx"], void 0, "vite-rsc/importer-resources");
var apiUrl = (process.env.INVENTORY_API_URL || "https://buildanta-monorepo-nest-api.vercel.app").replace(/\/$/, "");
async function getPublicCalculators() {
	try {
		const response = await fetch(`${apiUrl}/calculators/public`, {
			headers: { accept: "application/json" },
			cache: "no-store"
		});
...
async function getPublicCalculator(slug) {
	try {
		const response = await fetch(`${apiUrl}/calculators/public/${encodeURIComponent(slug)}`, {
			headers: { accept: "application/json" },
			cache: "no-store"
		});
...
var groups = [{
	title: "Structure",
	description: "Plan concrete, masonry and structural material quantities.",
	types: [
		"CEMENT_CONCRETE",
		"BRICKS_BLOCKS",
		"TMT_REBAR"
	...
	title: "Finishing",
	description: "Estimate surface materials using managed coverage and wastage.",
	types: [
		"TILES_FLOORING",
		"PAINT",
		"WATERPROOFING"
...
function CalculatorCard({ calculator }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
		className: calculator_module_default.card,
		href: `/calculators/${calculator.slug}`,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
				className: calculator_module_default.icon,
				children: symbols[calculator.type] || "CALC"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: calculator.name }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: calculator.description }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Start calculation ->" })
		]
	});
}
async function CalculatorsPage() {
	const calculators = await getPublicCalculators();
	const planner = calculators.find((calculator) => calculator.type === "BUILDING_BUDGET");
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: calculator_module_default.page,
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: calculator_module_default.hero,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
					className: calculator_module_default.eyebrow,
					children: "Buildanta project planning"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Plan quantities before requesting prices." }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Choose a full-project scope or use a specialist calculator. Every result uses a managed formula version, published Inventory products, PIN-code serviceability and the existing quotation workflow." }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: calculator_module_default.trust,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Square feet and metric inputs" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Managed formula versions" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Live catalogue mappings" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "One multi-item quotation" })
					]
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: calculator_module_default.content,
			children: [
				planner && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
					className: calculator_module_default.featuredPlanner,
					href: `/calculators/${planner.slug}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							className: calculator_module_default.eyebrow,
							children: "Complete project planner"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Get full construction material info" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Enter the project name, site area, built-up area, floors, rooms and required construction scope. Receive a stage-wise preliminary material schedule with Inventory products and indicative values." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: calculator_module_default.plannerChips,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Foundation only" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Structural shell" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Full finished plan" })
							]
						})
					] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
						className: calculator_module_default.plannerAction,
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "BOQ" }), "Start complete plan ->"]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: calculator_module_default.intro,
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
						className: calculator_module_default.eyebrow,
						children: "Specialist calculators"
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Calculate one part of the project" })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Use the focused tools when you already know the dimensions for a concrete component, wall, tiled surface or room." })]
				}),
				calculators.length ? groups.map((group) => {
					const entries = calculators.filter((calculator) => group.types.includes(calculator.type));
					return entries.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						className: calculator_module_default.calculatorGroup,
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: group.title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: group.description })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: calculator_module_default.grid,
							children: entries.map((calculator) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(CalculatorCard, { calculator }, calculator.id))
						})]
					}, group.title) : null;
				}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: calculator_module_default.empty,
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Calculators are temporarily unavailable" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Please try again after the Inventory API is running." })]
				})
			]
		})]
	});
}
var $$wrap_CalculatorsPage = /* @__PURE__ */ __vite_rsc_wrap_css__$1(CalculatorsPage, "default");
...
var ServiceabilityChecker = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ServiceabilityChecker' is called on server");
}, "47c6044e280a", "ServiceabilityChecker");
var page_exports$12 = /* @__PURE__ */ __exportAll({ default: () => Categories });
var categoryFallbacks = [
	{
		...
		src: "/demo/products/copper-wire.png"
	},
	{
		terms: ["paint", "finish"],
		src: "/demo/hero/finish-selection.png"
	},
	{
		terms: ["tile", "floor"],
		src: "/demo/products/porcelain-tile.png"
	},
	{
		terms: [
			"sanitary",
		...
		src: "/demo/products/basin-faucet.png"
	},
	{
		terms: [
			"cement",
		...
		src: "/demo/products/cement.png"
	},
	{
		terms: ["steel", "tmt"],
		src: "/demo/products/tmt-steel.png"
	},
	{
		terms: ["waterproof", "roof"],
		src: "/demo/hero/build-journey.png"
	},
	{
		terms: [
			"door",
	...
	},
	{
		...
		src: "/demo/hero/project-planning.png"
	}
];
...
function categoryProducts(products, categoryName) {
...
async function Categories({ searchParams }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "taxonomy-serviceability",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ServiceabilityChecker, {})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "EXPLORE THE LIVE CATALOGUE" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Everything your project needs, organized clearly." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Browse materials by category, compare current products and send one clear quotation request. Product names, images and availability are read directly from Buildanta Inventory." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: roots.length }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "material categories" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: catalog.products.length }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "published products" })
						] })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "category-hero-gallery",
					"aria-label": "Construction material catalogue preview",
					children: heroImages.map((src, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figure", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
						src,
						alt: index === 0 ? "Structural construction material" : index === 1 ? "Finishing material" : "Fixture and fitting"
					}) }, `${src}-${index}`))
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("label", {
						...
						children: "Search categories or brands"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("input", {
						id: "category-search",
						name: "q",
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("button", { children: "Search" })
				]
			}),
			needle && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "search-product-results",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "section-heading-row",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Search results" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: matchedProducts.length ? `${matchedProducts.length} matching products` : "No matching products" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: matchedProducts.length ? "Live published products from Buildanta Inventory." : "Try a product, brand, category or specification." })
					] })
				}), matchedProducts.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "products-grid",
					children: matchedProducts.map((product) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProductCard, { product }, product.id))
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "section-heading-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Browse the catalogue" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: needle ? "Matching categories" : "Construction material categories" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Open any category to see its live products, prices and quotation options." })
					] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						className: "view-all",
						href: "/bulk-quotes",
						children: ["Request a bulk quote ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })]
					})]
				}), filtered.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					...
					children: filtered.map((category) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
								className: "taxonomy-card-visual",
								href: `/categories/${category.slug}`,
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
										src: previewImage,
									...
									livePreview && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", { children: "Live Inventory image" })
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "taxonomy-card-copy",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Construction category" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
										href: `/categories/${category.slug}`,
										children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: category.name })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: category.description || (products.length ? `Featuring ${products.slice(0, 2).map((product) => product.name).join(" and ")}.` : "Products can be published here from Buildanta Inventory.") }),
									brands.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: brands.join(" · ") }),
									children.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: children.slice(0, 5).map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
										href: `/categories/${item.slug}`,
										children: [item.name, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "›" })]
									}) }, item.id)) }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
										className: "taxonomy-card-action",
										href: `/categories/${category.slug}`,
										children: [
											"Explore ",
											category.name,
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "No matching categories" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Try another product, category or brand name." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: "/categories",
...
var layout_exports$5 = /* @__PURE__ */ __exportAll({
	default: () => Layout$5,
	metadata: () => metadata$5
});
var metadata$5 = {
	title: "Construction Material Categories",
	description: "Compare cement, steel, electrical, paints, tiles, bathware and other construction-material categories on Buildanta."
};
function Layout$5({ children }) {
	return children;
}
var page_exports$11 = /* @__PURE__ */ __exportAll({ default: () => InventoryRedirect });
function InventoryRedirect() {
	redirect("http://localhost:3002/dashboard");
}
var page_exports$10 = /* @__PURE__ */ __exportAll({ default: () => InventoryQuotesRedirect });
function InventoryQuotesRedirect() {
	redirect("http://localhost:3002/dashboard");
}
var SupplierForm = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'SupplierForm' is called on server");
}, "251bfebdf721", "SupplierForm");
var page_exports$9 = /* @__PURE__ */ __exportAll({ default: () => ListProduct });
function ListProduct() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "workflow-page supplier-page",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "workflow-intro",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "FOR MANUFACTURERS & SUPPLIERS" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "List your Products" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Reach builders, contractors and homeowners actively sourcing construction materials through Buildanta." }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Qualified demand" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Get discovered by buyers planning real projects." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "02" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Verified catalogue" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Clear product data builds confidence and reduces back-and-forth." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "03" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Managed enquiries" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Respond to organised requirements from one place." })
						] })
					]
				})
			]
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Add a product" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Listings are reviewed before appearing in the catalogue." }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SupplierForm, {})
			]
		})]
	});
}
var layout_exports$4 = /* @__PURE__ */ __exportAll({
	default: () => Layout$4,
	metadata: () => metadata$4
});
var metadata$4 = {
	title: "List Construction Products",
	description: "Submit construction products for review and catalogue listing through Buildanta."
};
function Layout$4({ children }) {
	return children;
}
var CustomerAuthForm = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'CustomerAuthForm' is called on server");
}, "ff0ff5bd658b", "CustomerAuthForm");
var page_exports$8 = /* @__PURE__ */ __exportAll({ default: () => LoginPage });
async function LoginPage() {
	const customer = await getCustomerUser();
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "auth-page",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
			className: "wordmark auth-logo",
			href: "/",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
				src: "/logo.png",
				alt: ""
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Buildanta" })]
		}), customer ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
				className: "form-kicker",
				children: "SIGNED IN"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Welcome back." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
				"You are signed in as ",
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: customer.displayName }),
				"."
			] }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
				className: "button navy wide",
				href: "/account",
				children: ["Open customer account ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })]
			})
		] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
				className: "form-kicker",
				children: "BUILDANTA CUSTOMER"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Welcome back." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Sign in with your email and password to manage your customer account and project enquiries." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(CustomerAuthForm, { mode: "login" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
				className: "auth-switch",
				children: ["New to Buildanta? ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
					href: "/signup",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
				src: "/homepage_img.png",
				alt: "Modern home under renovation"
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "ONE CATALOGUE. ONE WORKSPACE." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Source every build detail with confidence." })] })]
		})]
	});
}
...
var metadata$3 = {
	...
	description: "Sign in securely to your Buildanta customer account.",
	robots: {
		index: false,
		follow: false
	}
};
function Layout$3({ children }) {
	return children;
}
var page_exports$7 = /* @__PURE__ */ __exportAll({ default: () => More });
function More() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "more-page",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "page-intro",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "MORE FROM BUILDANTA" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Tools for better building" }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Professional sourcing, supplier onboarding and practical project support—all connected." })
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
			className: "more-grid",
			children: [
				[
					"Get Bulk Quotes",
					"Competitive project pricing for builders, contractors and procurement teams.",
					"/bulk-quotes",
					"→"
				],
				[
					"List your Products",
					"Put your construction products in front of high-intent buyers.",
					"/list-product",
					"→"
				],
				[
					"Inventory Portal",
					"Manage catalogue stock and review quote requests in one protected workspace.",
					"/inventory",
					"→"
				],
				[
					"Preview My Reno",
					"Visualise renovation possibilities before making material decisions.",
					"#",
					"Coming soon"
				]
			].map(([title, text, href, action]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
				className: href === "#" ? "disabled" : "",
				href,
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: title.slice(0, 1) }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: action })
				]
			}, title))
		})]
	});
...
var metadata$2 = {
	...
	description: "Explore Buildanta professional discovery, bulk quotes, supplier listings and inventory services."
};
...
function ProfessionalCard({ professional }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
			...
			href: profileUrl,
			children: [professional.photoUrl ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
				src: professional.photoUrl,
				alt: professional.name,
				loading: "lazy"
			}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: initials }), professional.featured ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Featured" }) : null]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "professional-card-body",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: category?.singular }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
					href: profileUrl,
					children: professional.name
				}) }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: professional.headline || `Trusted ${category?.singular?.toLowerCase() ?? "professional"}` }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "professional-card-meta",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["⌖ ", professional.location] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [professional.yearsExperience, " yrs experience"] })]
				}),
				professional.services.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: professional.services.slice(0, 3).map((service) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: service }, service)) }) : null,
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
					className: "professional-profile-link",
					href: profileUrl,
					children: ["View full profile ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })]
				})
			]
		})]
	});
}
var page_exports$6 = /* @__PURE__ */ __exportAll({ default: () => ProfessionalsDirectoryPage });
async function ProfessionalsDirectoryPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "BUILDANTA PROFESSIONAL NETWORK" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Find the right expert for every build." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Explore verified professionals by speciality, location and experience. Every profile is managed through the Buildanta inventory workspace." })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
				className: "professional-category-section",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "professional-category-cards",
					children: professionalCategories.map((category) => {
						const count = professionals.filter((item) => item.type === category.type).length;
						return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
							href: `/professionals/${category.slug}`,
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", { children: category.short }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: category.title }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: category.description }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [
									count,
									" ",
									count === 1 ? "professional" : "professionals",
									" ",
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "→" })
								] })
							] })]
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "professional-results",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "professional-results-head",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "PROFESSIONAL DIRECTORY" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Meet Buildanta professionals" })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [professionals.length, " published profiles"] })]
				}), professionals.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "professional-grid",
					children: professionals.map((professional) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProfessionalCard, { professional }, professional.id))
				}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "professional-empty",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "◎" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Profiles are being added" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Our team is preparing trusted professional profiles. Please check back shortly." })
					]
				})]
			})
		]
...
var metadata$1 = {
	title: "Find Construction Professionals",
	description: "Explore Buildanta contractors, interior designers, builders, architects and construction product specialists."
};
function Layout$1({ children }) {
	return children;
}
var page_exports$5 = /* @__PURE__ */ __exportAll({ default: () => SignupPage });
async function SignupPage() {
	const customer = await getCustomerUser();
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "auth-page",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
				className: "wordmark auth-logo",
				href: "/",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: customer ? "Your account is ready." : "Join Buildanta." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: customer ? `Continue as ${customer.displayName} to access your customer account.` : "Create an account for product discovery, project requirements and quote requests." }),
			customer ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
				className: "button navy wide",
				href: "/account",
				children: ["Open customer account ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })]
			}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(CustomerAuthForm, { mode: "signup" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
				className: "auth-switch",
				children: ["Already have an account? ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
					href: "/login",
					children: "Customer login"
				})]
			})
		] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "auth-image supplier",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
				src: "/forprofessionalsbanner.png",
				alt: "Construction professionals"
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "BUILT FOR EVERY PROJECT" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "One reliable source for construction materials." })] })]
		})]
	});
}
...
var metadata = {
	...
	description: "Create your Buildanta customer account for product discovery and project quote requests.",
	robots: {
		index: false,
		follow: false
	}
...
async function GET$1(_request, { params }) {
	const { slug } = await params;
	try {
...
})(import_react_react_server.default, __vite_rsc_assets_manifest_default.serverResources["app/calculators/[slug]/page.tsx"], void 0, "vite-rsc/importer-resources");
var CalculatorWizard = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'CalculatorWizard' is called on server");
}, "2267e6aaddbb", "CalculatorWizard");
var page_exports$4 = /* @__PURE__ */ __exportAll({
	default: () => $$wrap_CalculatorPage,
	dynamic: () => dynamic,
...
async function CalculatorPage({ params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: calculator_module_default.page,
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: calculator_module_default.calculatorHero,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
					href: "/calculators",
					children: "<- All material calculators"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
					className: calculator_module_default.eyebrow,
					style: {
					...
					children: ["Inventory formula version ", calculator.currentVersion.version]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: calculator.name }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: calculator.description })
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(CalculatorWizard, { calculator })]
	});
}
var $$wrap_CalculatorPage = /* @__PURE__ */ __vite_rsc_wrap_css__(CalculatorPage, "default");
...
async function generateMetadata$2({ params }) {
	...
	return {
		...
		description,
		openGraph: {
			title: `${category.name} | Buildanta`,
			description
		}
	};
}
async function CategoryPage({ params, searchParams }) {
	const [{ slug }, { q = "" }, catalog] = await Promise.all([
		params,
		searchParams,
		getCatalogSnapshot()
	]);
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("nav", {
				...
				children: [
					...
					crumbs.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
						className: "breadcrumb-part",
						children: ["› ", index === crumbs.length - 1 ? item.name : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: `/categories/${item.slug}`,
							children: item.name
						})]
					}, item.id))
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "page-intro category-page-intro",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "BUILDANTA CATEGORY" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: category.name }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: category.description || "Compare live products from approved suppliers and request project pricing." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("small", { children: [productCount, " published products across this category"] })
				] }), category.imageUrl && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
					src: category.imageUrl,
					alt: `${category.name} materials`
				})]
			}),
			children.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "child-category-section",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "section-heading-row",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Continue browsing" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"Shop ",
							category.name,
							" by type"
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Choose a subcategory before comparing real products." })
					] })
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "child-category-grid",
					children: children.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						href: `/categories/${item.slug}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: item.imageUrl ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
							src: item.imageUrl,
							alt: ""
						}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: item.name.slice(0, 1) }) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: item.name }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: item.description || "Browse published products." }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("small", { children: [catalog.products.filter((product) => product.categories.includes(item.name)).length, " products →"] })
						] })]
					}, item.id))
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProductBrowser, {
				mode: "category",
				products: catalog.products,
				options: descendants.map((item) => item.name),
...
var ProductDetailClient = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ProductDetailClient' is called on server");
}, "0d5138b86f6e", "ProductDetailClient");
...
async function ProductDetail({ params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProductDetailClient, { product }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "spec-section",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "PRODUCT DETAILS" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Live product information." })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: product.specs.map((spec, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "✓" }), spec] }, `${spec}-${index}`)) })]
			}),
			related.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "section-heading-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Continue sourcing" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Related building materials" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "More live products from the same construction category." })
					] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						className: "view-all",
						href: `/categories/${product.categorySlug}`,
						children: ["View category ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "→" })]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "products-grid",
					children: related.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProductCard, { product: item }, item.id))
				})]
			})
		]
	});
}
var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => ProfessionalTypePage });
async function ProfessionalTypePage({ params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "professionals-page",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "professional-type-hero",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
					href: "/professionals",
					children: "Professional network"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [" / ", category.title] }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: category.short }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: category.title }),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: category.description })
			] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Available profiles" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: professionals.length })] })]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "professional-results",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "professional-results-head",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "BUILDANTA DIRECTORY" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [category.title, " near you"] })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
					href: "/professionals",
					children: "Browse all types"
				})]
			}), professionals.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "professional-grid",
				children: professionals.map((professional) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProfessionalCard, { professional }, professional.id))
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The inventory team can add and publish profiles from the Professionals management area." })
				]
			})]
		})]
	});
...
var page_exports = /* @__PURE__ */ __exportAll({
	default: () => ProfessionalProfilePage,
...
async function ProfessionalProfilePage({ params }) {
	const { type, slug } = await params;
	const category = categoryBySlug(type);
	if (!category) notFound();
	...
	const externalPortfolio = professional.portfolioUrl && !professional.portfolioUrl.endsWith("#selected-work") ? professional.portfolioUrl : null;
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		className: "professional-profile-page",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "professional-breadcrumbs",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
						href: "/",
						children: "Home"
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "professional-profile-hero",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "professional-profile-photo",
					children: professional.photoUrl ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
						src: professional.photoUrl,
						alt: professional.name
					}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: initials })
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "professional-profile-intro",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: category.singular }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: professional.name }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: professional.headline || `Trusted ${category.singular.toLowerCase()}` }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["⌖ ", professional.location] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [
							"◷ ",
							professional.yearsExperience,
							" years of experience"
						] })] }),
						professional.featured ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Buildanta featured professional" }) : null
					]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "professional-profile-content",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "profile-kicker",
						children: "ABOUT THE PROFESSIONAL"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Experience you can understand." }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "professional-bio",
						children: professional.bio || `${professional.name} is a ${category.singular.toLowerCase()} serving projects in ${professional.location}. Contact the professional directly for capabilities, availability and project details.`
					}),
					professional.services.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "Services and specialities" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", {
						className: "professional-services",
						children: professional.services.map((service) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: ["✓ ", service] }, service))
					})] }) : null
				] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Professional details" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dl", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Location" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: professional.location })] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Experience" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dd", { children: [professional.yearsExperience, " years"] })] }),
						professional.email ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Email" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: `mailto:${professional.email}`,
							children: professional.email
						}) })] }) : null,
						professional.phone ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Phone" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: `tel:${professional.phone}`,
							children: professional.phone
						}) })] }) : null
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						className: "button orange wide",
						href: externalPortfolio || "#selected-work",
						target: externalPortfolio ? "_blank" : void 0,
						rel: externalPortfolio ? "noreferrer" : void 0,
						children: ["View past work ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: externalPortfolio ? "↗" : "↓" })]
					}),
					professional.website ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
						className: "professional-website",
						href: professional.website,
						target: "_blank",
						rel: "noreferrer",
						children: "Visit professional website ↗"
					}) : null
				] })]
			}),
			representativeWork.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "professional-work",
				id: "selected-work",
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "professional-work-heading",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
							id: "selected-work-title",
							children: "Representative project capabilities"
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Demo portfolio content. Replace it with verified project details and an external portfolio link from Inventory before public launch." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "professional-work-grid",
						children: representativeWork.map((service, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: ["0", index + 1] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: service }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Planning, material coordination and delivery support tailored to the project brief." })
						] }, service))
					})
				]
			}) : null
...
var routes = [
	{
		...
		ids: {
			"route": "route:/api/calculators/estimates/:reference/quotation",
			"page": null,
			"routeHandler": "route-handler:/api/calculators/estimates/:reference/quotation",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/calculators/estimates/:reference/quotation",
		patternParts: [
			"api",
			"calculators",
			"estimates",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/calculators/:slug/calculate",
			"page": null,
			"routeHandler": "route-handler:/api/calculators/:slug/calculate",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/calculators/:slug/calculate",
		patternParts: [
			"api",
			"calculators",
			":slug",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/calculators",
			"page": null,
			"routeHandler": "route-handler:/api/calculators",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/calculators",
		patternParts: ["api", "calculators"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: null,
	...
	},
	{
		...
		ids: {
			"route": "route:/api/customer-auth/login",
			"page": null,
			"routeHandler": "route-handler:/api/customer-auth/login",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/customer-auth/login",
		patternParts: [
			"api",
			"customer-auth",
			"login"
	...
	},
	{
		...
		ids: {
			"route": "route:/api/customer-auth/logout",
			"page": null,
			"routeHandler": "route-handler:/api/customer-auth/logout",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/customer-auth/logout",
		patternParts: [
			"api",
			"customer-auth",
			"logout"
	...
	},
	{
		...
		ids: {
			"route": "route:/api/customer-auth/session",
			"page": null,
			"routeHandler": "route-handler:/api/customer-auth/session",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/customer-auth/session",
		patternParts: [
			"api",
			"customer-auth",
			"session"
	...
	},
	{
		...
		ids: {
			"route": "route:/api/customer-auth/signup",
			"page": null,
			"routeHandler": "route-handler:/api/customer-auth/signup",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/customer-auth/signup",
		patternParts: [
			"api",
			"customer-auth",
			"signup"
	...
	},
	{
		...
		ids: {
			"route": "route:/api/quotes",
			"page": null,
			"routeHandler": "route-handler:/api/quotes",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
	...
	},
	{
		...
		ids: {
			"route": "route:/api/serviceability",
			"page": null,
			"routeHandler": "route-handler:/api/serviceability",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/serviceability",
		patternParts: ["api", "serviceability"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: null,
		...
		layouts: [layout_exports$9],
		routeSegments: ["api", "serviceability"],
		templateTreePositions: [],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
	...
	},
	{
		...
		ids: {
			"route": "route:/api/suppliers",
			"page": null,
			"routeHandler": "route-handler:/api/suppliers",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
	...
	},
	{
		...
		ids: {
			"route": "route:/auth/confirm",
			"page": "page:/auth/confirm",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/bulk-quotes",
			"page": "page:/bulk-quotes",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/bulk-quotes"],
			"templates": [],
			"slots": {}
		},
		pattern: "/bulk-quotes",
		patternParts: ["bulk-quotes"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$16,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$8],
		routeSegments: ["bulk-quotes"],
		templateTreePositions: [],
	...
	},
	{
		...
		ids: {
			...
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/by-room"],
			"templates": [],
			"slots": {}
		},
		pattern: "/by-room",
		patternParts: ["by-room"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$15,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$7],
		routeSegments: ["by-room"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			"route": "route:/by-stage",
			"page": "page:/by-stage",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/by-stage"],
			"templates": [],
			"slots": {}
		},
		pattern: "/by-stage",
		patternParts: ["by-stage"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$14,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$6],
		routeSegments: ["by-stage"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			...
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/categories"],
			"templates": [],
			"slots": {}
		},
		pattern: "/categories",
		patternParts: ["categories"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$12,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$5],
		routeSegments: ["categories"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			"route": "route:/inventory/quotes",
			"page": "page:/inventory/quotes",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
		...
		pattern: "/inventory/quotes",
		patternParts: ["inventory", "quotes"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		...
		routeHandler: null,
		layouts: [layout_exports$9],
		routeSegments: ["inventory", "quotes"],
		templateTreePositions: [],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
	...
	},
	{
		...
		ids: {
			"route": "route:/list-product",
			"page": "page:/list-product",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/list-product"],
			"templates": [],
			"slots": {}
		},
		pattern: "/list-product",
		patternParts: ["list-product"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$9,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$4],
		routeSegments: ["list-product"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		page: page_exports$8,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$3],
		routeSegments: ["login"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
	...
	},
	{
		...
		page: page_exports$7,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$2],
		routeSegments: ["more"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
	...
	},
	{
		...
		ids: {
			...
			"page": "page:/professionals",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/professionals"],
			"templates": [],
			"slots": {}
		},
		pattern: "/professionals",
		patternParts: ["professionals"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$6,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$1],
		routeSegments: ["professionals"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		page: page_exports$5,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports],
	...
	},
	{
		...
		ids: {
			"route": "route:/api/calculators/:slug",
			"page": null,
			"routeHandler": "route-handler:/api/calculators/:slug",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/calculators/:slug",
		patternParts: [
			"api",
			"calculators",
			":slug"
	...
	},
	{
		...
		ids: {
			"route": "route:/api/supplier-images/:file",
			"page": null,
			"routeHandler": "route-handler:/api/supplier-images/:file",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/supplier-images/:file",
		patternParts: [
			"api",
			"supplier-images",
			":file"
	...
	},
	{
		...
		ids: {
			"route": "route:/calculators/:slug",
			"page": "page:/calculators/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
		...
		routeHandler: null,
		layouts: [layout_exports$9],
		routeSegments: ["calculators", "[slug]"],
		templateTreePositions: [],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
	...
	},
	{
		...
		ids: {
			"route": "route:/categories/:slug",
			"page": "page:/categories/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/categories"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/professionals/:type",
			"page": "page:/professionals/:type",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/professionals"],
			"templates": [],
		...
		pattern: "/professionals/:type",
		patternParts: ["professionals", ":type"],
		isDynamic: true,
		params: ["type"],
		rootParamNames: [],
		page: page_exports$1,
		routeHandler: null,
		layouts: [layout_exports$9, layout_exports$1],
		routeSegments: ["professionals", "[type]"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			"route": "route:/professionals/:type/:slug",
			"page": "page:/professionals/:type/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/professionals"],
			"templates": [],
		...
		pattern: "/professionals/:type/:slug",
		patternParts: [
			"professionals",
			":type",
			":slug"
...
var rootLayouts = [layout_exports$9];
...
*/
var __MAX_ACTION_BODY_SIZE = 6291456;
var generateStaticParamsMap = {
	"/calculators/:slug": null,
	"/categories/:slug": null,
	"/products/:slug": null,
	"/professionals/:type": null,
	"/professionals/:type/:slug": null
};
