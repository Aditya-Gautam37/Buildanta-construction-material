...
const priceNotice = "Indicative Delhi NCR catalogue price updated August 2026. Final price, tax treatment, freight, batch, shade and availability are confirmed in the supplier quotation."
...
const products: ProductDefinition[] = [
  { name:"UltraTech Portland Pozzolana Cement — 50 kg",brand:"UltraTech Cement",categorySlug:"cement-structure/cement/ppc",asset:"cement",description:"Portland pozzolana cement for durable masonry, plastering and general concrete work.",price:325,bulkPrice:315,unit:"50 kg bag",minimumOrder:10,gst:28,stage:"Foundation & Structure",specs:["PPC grade","50 kg bag","General concrete, masonry and plastering"],variants:[{sku:"UTC-PPC-50KG",price:325,attributes:{grade:"PPC",pack:"50 kg"}}] },
  { name:"UltraTech OPC 53 Cement — 50 kg",brand:"UltraTech Cement",categorySlug:"cement-structure/cement/opc-53",asset:"cement",description:"High early-strength ordinary Portland cement for reinforced structural concrete.",price:365,bulkPrice:352,unit:"50 kg bag",minimumOrder:10,gst:28,stage:"Foundation & Structure",specs:["OPC 53 grade","50 kg bag","RCC and structural applications"],variants:[{sku:"UTC-OPC53-50KG",price:365,attributes:{grade:"OPC 53",pack:"50 kg"}}] },
  ...
  { name:"Asian Paints Royale Luxury Emulsion — 20 L",brand:"Asian Paints",categorySlug:"paints-finishing/interior/emulsion",asset:"paint",description:"Premium washable interior-wall emulsion with a smooth soft-sheen finish.",price:15210,bulkPrice:11650,unit:"20 L pail",minimumOrder:1,gst:18,stage:"Paint & Finishing",rooms:["Living room","Bedroom"],specs:["20 litre pack","Washable interior finish","Final price varies by shade and base"],variants:[{sku:"AP-ROYALE-20L-WHITE",price:15210,attributes:{pack:"20 L",base:"White/pastel"}},{sku:"AP-ROYALE-10L-WHITE",price:7750,attributes:{pack:"10 L",base:"White/pastel"}},{sku:"AP-ROYALE-4L-WHITE",price:3170,attributes:{pack:"4 L",base:"White/pastel"}}] },
...
async function main() {
  ...
  console.log(JSON.stringify({status:"complete",canonicalDepartments:9,products:productCount,variants:variantCount,brands:await prisma.brand.count(),supplier:supplier.name,priceBasis:"Indicative Delhi NCR, August 2026"},null,2))
}
