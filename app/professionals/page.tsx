...
export default async function ProfessionalsDirectoryPage() {
  ...
  return <main className="professionals-page">
    <section className="professional-hero"><img src="/images/buildanta-v2/professionals-network-v2.webp" alt="Indian architects, engineers and contractors collaborating over building plans" fetchPriority="high" /><div><p>BUILDANTA PROFESSIONAL NETWORK</p><h1>Find the right expert for every build.</h1><span>Explore verified professionals by speciality, location and experience. Every profile is managed through the Buildanta inventory workspace.</span></div></section>
